...
(function (global) {
  "use strict";
  const C = {
    cyan: "#00d4ff", coral: "#ff6b6b", gold: "#ffd43b",
    purple: "#845ef7", green: "#51cf66",
  };

  const FONT = { family: "Space Grotesk, sans-serif", color: "#c7cffb", size: 12 };
  const PLOT_BG = "rgba(0,0,0,0)";
  const GRID = "rgba(120,150,220,0.12)";
  const ZERO = "rgba(120,150,220,0.28)";
