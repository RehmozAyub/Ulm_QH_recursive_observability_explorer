...
(function (global) {
  ...
  const DEFAULTS = {
    ...
    O_floor: 1e-3, term_damping: true, I_abort: 1e4,
  ...
  const STAGES = {
    s0: { over: { A_rec: 0, F_key: "linear", O_key: "increasing", obs_mode: "static", p: 0, q: 0, r: 0, a: 0.0, b: 0.0, term_damping: false }, y0: [0.01, 0.5, 0.0] },
    s1: { over: { A_rec: 0, F_key: "linear", O_key: "increasing", obs_mode: "static", a: 0.30, b: 0.0, term_damping: false }, y0: [0.2, 0.5, 0.0] },
    s2: { over: { A_rec: 0.0, F_key: "saturating", O_key: "increasing", obs_mode: "dynamic", term_damping: false }, y0: [0.5, 0.5, 0.1] },
    s3: { over: { A_rec: 1.5, F_key: "saturating", O_key: "peaked", obs_mode: "dynamic" }, y0: [1.0, 0.7, 0.2] },
    s4a: { over: { A_rec: 4.0, A_ref: 0.2, w: 2.0, F_key: "saturating", O_key: "peaked", obs_mode: "dynamic", sR: 0.30 }, y0: [1.5, 0.3, 0.1] },
    s4b: { over: { A_rec: 1.0, a: 0.50, c: 0.15, sI: 0.05, r: 2.0, m: 0.1, n: 0.1, F_key: "saturating", O_key: "increasing", obs_mode: "dynamic" }, y0: [2.0, 0.9, 0.5] },
    s4c: { over: { A_rec: 1.0, a: 0.50, c: 0.20, sI: 0.05, m: 2.0, n: 2.0, p: 0.3, q: 0.2, r: 0.2, C_key: "superlinear", S_key: "superlinear", F_key: "saturating", O_key: "peaked", obs_mode: "dynamic", I_advanced: 2.0 }, y0: [1.0, 0.6, 0.1] },
    s5: { over: { A_rec: 2.0, A_ref: 2.0, F_key: "saturating", O_key: "peaked", obs_mode: "dynamic", m: 2.5, n: 2.5, C_key: "superlinear", S_key: "superlinear", tau_max: 100.0 }, y0: [2.0, 0.8, 0.3] },
  };
