...
Every symbol used in the paper, in the order the variables, drivers,
coefficients and derived quantities are introduced.

% Deliberately not a float: a bare table in a section with no body text
% drifts to the following page and leaves the heading stranded.
\begin{center}
\small
...
$\Iadv,\Rmin,\Theta$ & param & capability, regulation and runaway thresholds \\
